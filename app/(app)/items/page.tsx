    ...
    <div>
        ...
        <Card>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {filtered.length === 0 && (
                  <tr><td colSpan={11} className="text-center py-12 text-gray-400">No hay ítems</td></tr>
                )}
                {filtered.map((it) => (
                  <tr key={it.id_item} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
      ...
      <Modal open={open} onClose={() => setOpen(false)} title={editing ? `Editar ${editing.id_item}` : 'Nuevo Ítem'} size="xl">
        <div className="grid grid-cols-2 gap-4">
          ...
          {/* ETD/ETA informativo desde envío */}
          {selectedEnvio && (
